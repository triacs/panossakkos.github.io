...
I gave it some thought and I came up with the following system. I create a very strong password (let's call it secret passphrase) and every time that I want to create an account for service X, then I combine
