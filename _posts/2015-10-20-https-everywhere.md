...
layout: post
section-type: post
title: Contributing to HTTPS Everywhere and Tor
category: tech
tags: [ 'cypherpunk', 'opensource', 'tor' ]
---
There is a very simple way to have an impact on privacy and security by contributing to
<a href="https://www.eff.org/https-everywhere" target="_blank">HTTPS Everywhere</a>.
...
<a href="https://www.torproject.org/download/download-easy.html.en" target="_blank">Tor browser bundle</a> as well. The "*many major websites*" from the description, practically means that there are rules defined for the websites that support https.
...
<a href="https://github.com/EFForg/https-everywhere" target="_blank"> repo</a> and
